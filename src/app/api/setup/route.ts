  ...
  try {
    ...
    await prisma.evenement.createMany({
      data: [
        ...
        { id: 'event-3', organisationId: org.id, clientId: 'client-3', nom: 'Congrès Municipal Lyon 2026', type: 'CONGRES', statut: 'PROSPECTION', dateDebut: new Date(now.getFullYear(), now.getMonth() + 3, 20), nombreParticipants: 500, budgetIndicatif: 120000, probabilite: 40 },
        { id: 'event-4', organisationId: org.id, clientId: 'client-4', nom: 'Team Building StartupBoost', type: 'TEAMBUILDING', statut: 'EN_COURS', dateDebut: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 5), nombreParticipants: 50, budgetIndicatif: 15000, probabilite: 100 },
        { id: 'event-5', organisationId: org.id, clientId: 'client-5', nom: 'Mariage Beaumont-Laurent', type: 'MARIAGE', statut: 'REALISE', dateDebut: new Date(now.getFullYear(), now.getMonth() - 1, 12), nombreParticipants: 180, budgetIndicatif: 65000, probabilite: 100 },
